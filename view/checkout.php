        ...
        <div class="col-sm-6">
            <div class="shopper-info">
                ...
                <form action="process.php" method="post">
                    <input type="text" name="ho_ten" placeholder="Họ và Tên"><br>
                    <input type="text" name="dia_chi" placeholder="Địa Chỉ"><br>
                    <input type="text" name="dien_thoai" placeholder="Điện Thoại"><br>
                    <input type="text" name="gioi_tinh" placeholder="Giới Tính"><br>
                    <select name="hinh_thuc_thanh_toan">
                        <option value="Tiền Mặt">Tiền Mặt</option>
                        <option value="Chuyển Khoản">Chuyển Khoản</option>
                        <option value="Ship COD">Ship COD</option>
                    </select><br><br>
                    <input class="btn btn-primary" type="submit" name="dat_hang" value="Đặt Hàng">
                </form>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="order-message">
                <p>Ghi Chú Đơn Hàng và Giao Hàng</p>
                <textarea name="message" placeholder="Ghi Chú về Đơn Hàng hoặc Giao Hàng" rows="8"></textarea>
                <label><input type="checkbox"> Giao Hàng Đến Địa Chỉ Thanh Toán</label>
            </div>
        </div>
    </div>
</div>
