...
<head>
	...
	<link rel="apple-touch-icon-precomposed" sizes="144x144"
		href="view/images/ico/apple-touch-icon-144-precomposed.png">
	<link rel="apple-touch-icon-precomposed" sizes="114x114"
		href="view/images/ico/apple-touch-icon-114-precomposed.png">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="view/images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="view/checkout.php"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="index.php?act=addtocart"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								<?php
								if (isset($_SESSION['user'])) {
									extract($_SESSION['user']);

									?>
									<li><a href="index.php?act=dangxuat"><i class="fa fa-lock"></i> Đăng xuất</a></li>
								<?php
								} else {
									?>
			...
			<div class="container">
				<div class="row">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										...
										<li><a href="view/checkout.php">thanh toán</a></li>
					...
					<div class="col-sm-3">
						...
						<!-- <div class="col-sm-3">
						<input type="submit" value="tim" name="timkiem">
						</div> -->
					</div>
