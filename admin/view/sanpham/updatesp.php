    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input class="form-control" type="number" name="ma_sp" placeholder="">
              </div> --> <input type="hidden" name="ma_sp" value="<?= $ma_sp ?>" />
                            <!-- tensp -->
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <!-- <input type="hidden" name="ma_dm" value="<?= $id ?>"> -->
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control" type="date" name="ngay_tao" value="<?= $ngay_tao ?>">
                            </div>
