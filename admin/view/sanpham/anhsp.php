...
<head>
    <title>Thêm ảnh sản phẩm | Quản trị Admin</title>
    <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="./images/logo_coffee.png" width="50px"
                alt="User Image">
            <div>
                <p class="app-sidebar__user-name"><b>e_shopper</b></p>
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="../donhang/table-data-oder.php"><i
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Thêm mới ảnh sản phẩm</h3>
                    <div class="tile-body">
                        <div class="row element-button">
                            <form class="row" action="index.php?act=upanh" method="POST" enctype="multipart/form-data">
                                <div class="form-group col-md-3">
                                    <label class="control-label">Mã anh</label>
                                    <input class="form-control" type="text" name="ma_img">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">mã sản phẩm</label>
                                    <input class="form-control" type="text" name="ma_sp">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="control-label" class="form-label">Tải ảnh </label>
                                    <div class="file-upload-wrapper">
                                        <input type="file" id="form-category/image" name="anh1" class="file-upload"
                                            required />
                                    </div>
                                </div>
