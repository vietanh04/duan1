...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="./images/logo_coffee.png" width="50px"
        alt="User Image">
      <div>
        <p class="app-sidebar__user-name"><b>CỬA HÀNG ĐIỆN THOẠI</b></p>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
            <form class="row" method="POST" action="index.php?act=editdh"> 
  <div class="form-group col-md-4">
    <label class="control-label">Mã đơn hàng</label>
    <input class="form-control" type="text" name="ma_don"  value="<?php  echo $ma_don ?>">
  </div>
  <div class="form-group col-md-4">
    <label class="control-label">Ngày đặt hàng</label>
    <input class="form-control" type="date" name="ngaydathang" value="<?php  echo $ngaydathang ?>">
  </div>
  <div class="form-group col-md-4">
    <label class="control-label">Tổng tiền</label>
    <input class="form-control" type="text" name="tongtien" value="<?php  echo $tongtien ?>">
  </div>
  <div class="form-group col-md-4">
    <label class="control-label">Trạng thái</label>
    <input class="form-control" type="text" name="trang_thai" value="<?php  echo $trang_thai ?>">
  </div>
  <div class="form-group col-md-4">
    <label class="control-label">Mã khách hàng</label>
    <input class="form-control" type="text" name="ma_kh" value="<?php  echo $ma_kh ?>">
  </div>
  <div class="form-group col-md-4">
  ...
  <div class="form-group col-md-4">
    ...
    <input class="form-control" type="text" name="pttt" value="<?php  echo $pttt ?>">
  </div>
  <div class="form-group col-md-4">
    <button class="btn btn-save" type="submit" name="capnhat">Cập nhật</button>
    <a class="btn btn-cancel" href="/doc/table-data-donhang.html">Hủy bỏ</a>
    <a class="btn btn-save" href="index.php?act=listdh">Danh sách</a>
  </div>
