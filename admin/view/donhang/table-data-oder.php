...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  foreach ($listdh as $row) {
    ...
    // Thêm thẻ a cho nút xóa
    echo "<a href='index.php?act=deletedh&ma_don=$ma_don' class='btn btn-primary btn-sm trash' title='Xóa'><i class='fas fa-trash-alt'></i></a>";

    // Thêm thẻ a cho nút sửa
    echo "<a href='index.php?act=suadh&ma_don=$ma_don' class='btn btn-primary btn-sm edit' title='Sửa'><i class='fa fa-edit'></i></a>";
