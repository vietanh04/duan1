...
if (isset($_POST['dangnhap']) && ($_POST['dangnhap'])) {
    $tai_khoan = $_POST['ten_tk'];
    $matkhau = $_POST['matkhau'];
    $checkuser = ktra_tk($tai_khoan, $matkhau);
    if (is_array($checkuser)) {
        ...
        if (isset($_SESSION['user'])&& $_SESSION['user']['ma_vaitro'] == 1) {
            ...
            $thongbao = 'Tài khoản không có quyền truy cập.';
        }
    } else {
                ...
                <form class="login100-form validate-form" action="login.php" method="post">
                    ...
                    <!--=====FORM INPUT TÀI KHOẢN VÀ PASSWORD======-->
                        ...
                        <div class="wrap-input100 validate-input">
                            <input class="input100" type="text" placeholder="Tài khoản quản trị" name="ten_tk"
                        ...
                        <div class="wrap-input100 validate-input">
                            <input autocomplete="off" class="input100" type="password" placeholder="Mật khẩu"
                                name="matkhau" id="password-field" required>
                        ...
                        <input type="submit" value="Đăng nhập" name="dangnhap" id="submit" />
                        </div>
                        <!--=====LINK TÌM MẬT KHẨU======-->
