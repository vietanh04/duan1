...
{
    $sql = "SELECT * FROM db_sanpham where 1 order by ma_sp desc limit 0,6";
    $listsp = pdo_query($sql);
    return $listsp;
...
{
    $sql = "SELECT * FROM db_sanpham where 1 order by ma_sp asc limit 0,3";
    $listsp = pdo_query($sql);
    return $listsp;
...
{
    $sql = "SELECT * FROM db_sanpham where 1 order by ma_sp asc limit 0,4";
    $listsp = pdo_query($sql);
    return $listsp;
